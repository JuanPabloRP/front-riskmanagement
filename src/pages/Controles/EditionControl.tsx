...
const EditControl = () => {
    ...
    // Recibir control seleccionado desde el estado de navegación o una consulta a la API si es necesario
    const selectedControl: ControlType = location.state;

    // Estado para el formulario de edición
    const [control, setControl] = useState<ControlType>(selectedControl);
